---
title: "Starter Kit for Data Science (R)"
...
One can extract also a specific column from a data frame using its column name in Python `pandas.DataFrame`. 
